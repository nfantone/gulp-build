...
var Config = (function() {
  ...
  function BuildConfig(options) {
    self = this;
    var config = _.defaultsDeep(options || {}, BuildConfig.DEFAULTS);
    ...
    // Make .less sources globs relative to root directory
    config.src.less = this._absolutify(config.src.root, config.src.less);
