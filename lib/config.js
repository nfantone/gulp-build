...
var Config = (function() {
  ...
  function BuildConfig(options) {
    self = this;
    var config = _.defaults(_.clone(options) || {}, BuildConfig.DEFAULTS);
    _.defaults(config.optimize, BuildConfig.DEFAULTS.optimize);
    _.defaults(config.templateCache, BuildConfig.DEFAULTS.templateCache);
